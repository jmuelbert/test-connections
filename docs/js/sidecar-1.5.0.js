...
var sidecar = (function (t) {
				...
				return (
					e.targetElement.forEach(function (r) {
						...
						a.classList.add('gitter-chat-embed-action-bar-item'),
							a.classList.add('gitter-chat-embed-action-bar-item-collapse-chat'),
					...
					a(t, [
						{
							...
							value: function () {
								...
								e.useStyles && this[C].add(h()),
									...
									e.showChatByDefault
										? this.toggleChat(!0)
										: (void 0 === e.activationElement || e.activationElement === !0
	...
	function (t, e) {
		...
		function u(t, e, i) {
			return (
				void 0 !== i ? (i ? t.classList.add(e) : t.classList.remove(e)) : t.classList.toggle(e), i
			);
		}
		Object.defineProperty(e, '__esModule', {value: !0}),
			(e.forEach = r),
				...
				(t.i = function (e, i) {
					...
					for (n = 0; n < e.length; n++) {
						...
						('number' == typeof a[0] && r[a[0]]) ||
							(i && !a[2] ? (a[2] = i) : i && (a[2] = '(' + a[2] + ') and (' + i + ')'), t.push(a));
					}
				}),
				t
			);
